...
public class AI {
	...
	public int evaluateBoard(Color color, int depth) 
	{
	...
	{	
		...
		return new LogicPlace(-1, -1, null, evaluateBoard(color, depth));
	}
	...
	{	
		...
		return new Move(-1, -1, -1, -1, evaluateBoard(color, depth));
	}
}